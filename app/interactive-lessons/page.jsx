...
export default function Page() {
    return (
        <DashboardLayout>
          <div>
            <div className="justify-between items-stretch self-center flex w-full max-w-[1088px] gap-5 mt-11 max-md:max-w-full max-md:flex-wrap max-md:mt-10">
                <div className="text-stone-950 text-opacity-90 text-4xl font-bold leading-10 grow shrink basis-auto">
                Hello, John Doe
                </div>
                <div className="items-stretch border border-[color:var(--gray-400,rgba(13,13,13,0.30))] self-center flex grow basis-[0%] flex-col my-auto border-solid">
                <div className="items-stretch border border-[color:var(--gray-400,rgba(13,13,13,0.30))] shadow-sm bg-white flex justify-between gap-5 px-3.5 py-2.5 rounded-lg border-solid">
                    <div className="text-stone-950 text-opacity-50 text-base leading-6">
                    Search Lesson
                    </div>
                    <img
                    loading="lazy"
            ...
            <div className="flex flex-row justify-between items-start gap-9 w-full">
                <div className="w-full">
                    ...
                    >
                        {initialData.map((data, index) => {
                            return (
                            <li className="mt-[40px]" key={data.id}>
                                <div className="border border-[color:var(--gray-200,rgba(13,13,13,0.10))] shadow pr-4 rounded-lg border-solid max-md:max-w-full">
                                <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                                    <div className="flex flex-col items-stretch w-[33%] max-md:w-full max-md:ml-0">
                                        <Image
                                            ...
                                            height={1253}
                                            src={data.img}
                                            className="aspect-[1.25] object-contain w-[306px] h-full overflow-hidden shrink-0 max-w-full grow max-md:mt-8"
                                        />
                                    </div>
                ...
                <div className="flex flex-col justify-center items-center">
                    <div className="border mt-[40px] pl-8 pr-3 mb-[60px] pt-8 pb-2 rounded-lg border-solid max-md:mt-9 max-md:pl-5">
                        ...
                        <div className="justify-center items-center flex w-[125px] max-w-full gap-1 mt-2 pr-px">
